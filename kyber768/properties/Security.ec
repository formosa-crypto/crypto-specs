...
(* STOPPED HERE: WE PROBABLY WANT TO GO WITH PKE_HASH *)

(* We have that instantiating S with KSampler we get the Spec *)
lemma kg_sampler_kg (O <: SMP_RO) :
  equiv [   KyberS(KHS,KSampler(XOF),KNS,KPRF,KPRF,O).kg ~ InnerPKE_rnd.kg : 
