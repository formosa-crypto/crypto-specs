...
op decode_vec(l : int, bits : bool list) = map bs2int (chunk l (take (1024*l) bits)).
...
op sem_decode10_vec(a : W8.t Array960.t) : ipolyvec = 
   Array1024.of_list 0 (decode_vec 10 (BytesToBits (to_list a))).
op sem_decode12_vec(a : W8.t Array1152.t) : ipolyvec = 
   Array1024.of_list 0 (decode_vec 12 (BytesToBits (to_list a))).
